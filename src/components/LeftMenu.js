...
function LeftMenu () {
    ...
    <ul>
      ...
      <li>
        <Link className='nav-link' to="/year">
          <FormattedMessage id="year" defaultMessage="Year" />
        </Link>
      </li>
    </ul>
    <NavDropdown.Divider />
    <Link className='nav-link font-weight-bold' to="/plan-bills">
      <FormattedMessage id="planYourBills" defaultMessage="Plan your bills" />
    </Link>
    <NavDropdown.Divider />
    <Link className='nav-link font-weight-bold mb-2' to="/edit-categories">
      <FormattedMessage id="editCategories" defaultMessage="Edit categories" />
    </Link>
  </Nav>
}
