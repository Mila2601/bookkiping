...
function CatStatistics () {
    ...
    return <div className='statistics mt-4'>
        <h1><FormattedMessage id="catStatistic" defaultMessage="Monthly statistic by category:" /></h1>
        <select className="brands-select cat-select monthly-stat mr-4" name="category" id="category" onChange={ e => setSelectedCat(e.currentTarget.value)} />
